...
const Player = () => {
	...
	return (
		<div className="w-full fixed bottom-0 bg-[#000] h-20 md:py-[24px] py-2 px-5 flex items-center justify-between z-50">
			<div className="flex items-center gap-4">
				<img
					src={cover}
					className="rounded-md w-[45px]"
					alt="music"
				/>
			...
			<div className="flex items-center gap-4">
				<div className="flex items-center w-full gap-4">
					...
					<div className="flex items-center w-full gap-2">
						...
						<div
							className="md:w-[560px] w-[110px] bg-[#4d4d4d] rounded-md h-[6px] relative cursor-pointer"
